...
public class DynamicWebCalander {
	public WebDriver driver;
	public void selectDate(String month_year,String day)throws Exception{
		List<WebElement> elements = 
	driver.findElements(By.xpath("//*[@id='ui-datepicker-div']/div/div/div"));
	...
	for(int i=0;i<elements.size();i++) {
		...
		if(elements.get(i).getText().equals(month_year)) {
			...
			driver.findElements(By.xpath("//*[@id='ui-datepicker-div]/div[1]/table/tbody/tr/td/a"));
  ...
  public void f()throws Exception {
	  ...
	  String chkdate="30-Novenmber 2018";
